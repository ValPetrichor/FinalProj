...
import com.example.finalproj.DatabaseHandlerLogReg;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openHelper = new DatabaseHandlerLogReg(this);
    ...
    public void insertData(String fname,String fPhone,String fGmail,String fPassword){
        ...
        contentValues.put(DatabaseHandlerLogReg.COL_2,fname);
        contentValues.put(DatabaseHandlerLogReg.COL_3,fPhone);
        contentValues.put(DatabaseHandlerLogReg.COL_4,fGmail);
        contentValues.put(DatabaseHandlerLogReg.COL_5,fPassword);

        long id = db.insert(DatabaseHandlerLogReg.TABLE_NAME,null,contentValues);
    }
}
