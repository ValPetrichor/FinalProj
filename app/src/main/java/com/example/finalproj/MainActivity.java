        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.isEmpty() || password.isEmpty()) {
                    ...
                    cursor = db.rawQuery("SELECT *FROM " + DatabaseHandlerLogReg.TABLE_NAME + " WHERE " + DatabaseHandlerLogReg.COL_4 + "=? AND " + DatabaseHandlerLogReg.COL_5 + "=?", new String[]{email, password});
                    if (cursor != null) {
